...
import { IconCheckCircle, IconClose, IconVisible, IconVisibleOff, IconWarning } from "../../../components/SvgComponents/Icon"
    ...
    <>
      ...
      <div class="z-index-10 mtba float-center">
        ...
        <div class="modal-auth relative mrla gap10 bg-gray-900 p25">
          <h2 class="font-13 ma">Create account</h2>
          <div class="ma">
            Already have an account?{" "}
            <span class="color-magenta pointer">
              <Link href="/portal/signin/">Sign in</Link>
            </span>
          </div>
          <div class="">
