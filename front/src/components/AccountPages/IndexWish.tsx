...
export const IndexWish = component$(
  ({ wishItemObjArr, isLastSlice }: WishIndexObj) => {
      ...
      <div class="grid">
        ...
        <div style={{ overflow: "auto" }}>
          <div style={{ width: "100%", whiteSpace: "nowrap" }}>
            <div
              class="mini-button-magenta mtba"
        ...
        <div class="ma w100vw" style={{ maxWidth: "920px" }}>
          ...
          <div class="radius5 bg-gray-900 p8" style={{ overflow: "hidden" }}>
            {wishItemObjArr.map((singleWishItem, index) => (
              <div
                class="grid wish-card responsive-padding gap8 ptb9 border-bottom-until-last"
                key={singleWishItem.productId}>
                <div class="flex gap8">
                  <picture
                    class="inline-block order-card-body-thumb mtba"
                    ...
                    <source
                      ...
                      srcset={singleWishItem.thumbSetObject.avif[1]}
                      type="image/avif"
                    />
                    <source
                      media="(min-width:769px)"
                      srcset={singleWishItem.thumbSetObject.jpeg[1]}
                      type="image/jpeg"
                    />
                  ...
                  <div class="">
                    ...
                    <div class="font-9">
                      Price: $
                      <span class="font-12 font-weight-500">{`${singleWishItem.productPrice}`}</span>
                    </div>
          ...
          {isLastSlice && (
            <span class="end-of-list-border nowrap font-8 color-gray-600 mt10">
              End of your list
            </span>
          )}
        </div>
