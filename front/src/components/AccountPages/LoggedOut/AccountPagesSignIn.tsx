        ...
        <div class="">
          <div class="relative grid">
            ...
            <label
              ...
              style={{
                left:
                  inputStore.emailFocused || inputStore.emailValue !== ""
                    ? "16px"
                    : "8px",
                top:
                  inputStore.emailFocused || inputStore.emailValue !== ""
            ...
            {inputStore.emailHelper && (
              <span
                class="absolute flex align-center h100"
                style={{ right: "8px" }}>
                <IconWarning />
              </span>
            )}
        ...
        <div>
          <div class="relative grid">
            ...
            <label
              ...
              style={{
                left:
                  inputStore.passwordFocused || inputStore.passwordValue !== ""
                    ? "16px"
                    : "8px",
                top:
                  inputStore.passwordFocused || inputStore.passwordValue !== ""
            ...
            <span
              ...
              style={{ right: "8px" }}
              onClick$={() =>
                (inputStore.passwordVisible = !inputStore.passwordVisible)
              }>
